...
parser.add_argument('--lexicon', type=str, default='-', help='File name of a file that contains the'
                    'lexicon with monophones. Each line must be: <word> <phone1> <phone2> ...')
parser.add_argument('--nonsilence_biphones', type=str, default='-', help='Output file that contains'
...
def main():
    ...
    args.lexicon = '/Users/ashisharora/Desktop/corpora/kaldi_data_safet/e2e/dict_nosp/lexicon.txt'
    args.nonsilence_biphones = '/Users/ashisharora/Desktop/corpora/kaldi_data_safet/e2e/output/nonsilence_phones.txt'
    args.biphone_lexicon = '/Users/ashisharora/Desktop/corpora/kaldi_data_safet/e2e/output/bilexicon.txt'
